...
public class WordController {
    ...
    public String getUserWordlist(
        ...
        try {
            List<Wordlist> wordList = wordlistService.getUserWordList(userId, wordlistIdId);
            model.addAttribute("wordList", wordList);
            return "WordList/wordlist";
        }
        catch (Exception e) {
    ...
    public String wordList(
        ...
        try {
            List<Wordlist> wordList = wordlistService.getWordList(wordlistId, wordId);
            model.addAttribute("wordList", wordList);
            return "WordList/wordlist";
        }
        catch (Exception e) {
    ...
    public String createWordList(
            @RequestParam WordlistForm wordlistForm,
            Model model
    ) {
        try {
            wordlistService.createWordList(wordlistForm);
            return "WordList/wordlist";
        }
        catch (Exception e) {
            return "error";
